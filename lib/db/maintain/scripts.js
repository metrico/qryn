...
module.exports.overall_dist = [
  ...
  'ALTER TABLE {{DB}}.metrics_15s_dist ADD COLUMN IF NOT EXISTS `type` UInt8;',

  'ALTER TABLE {{DB}}.time_series_dist ADD COLUMN IF NOT EXISTS `type` UInt8',

  'ALTER TABLE {{DB}}.time_series_dist ADD COLUMN IF NOT EXISTS `type` UInt8;',

  'ALTER TABLE {{DB}}.time_series_gin_dist ADD COLUMN IF NOT EXISTS `type` UInt8;'
]
