...
module.exports = (token, query) => {
    ...
    return has_extra_labels(query) ? _and(query,ex) :
        ...
        if (t.name === "label_filter_expression") {
            ...
            switch (where.length) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    where_concat(where[1], and_or, ex);
                    break;
                default:
                    where_concat(where, and_or, ex);
            }
            and_or = null;
        }
        if (t.name === "bracketed_label_filter_expression" || t.name === "complex_label_filter_expression") {
            ...
            switch (where.length) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    where_concat(where[1], and_or, process_where_expression(t, query));
                    break;
                default:
                    where_concat(where, and_or, process_where_expression(t, query));
            }
        }
        if (t.name === "and_or") {
            and_or = t.value;
